...
- 今日完成時間、今日數學頁數、本週數學頁數與完成率集中顯示；數學頁數必須同時具備實際填入並保存的頁碼與完成勾選，Calendar 建議範圍本身不算紀錄。
- 各科完成時間以圓環圖呈現，環中顯示國／英／數／自／社，指向或點擊後顯示分鐘與占比。
- 教材進度圖由標題列直接在目前頁面跳轉，按科目切換並用深淺交錯長條顯示進度。
- 「學習總結」提供全頁共用的週／月切換；週曆／月曆、科目分配、學習趨勢、平均起床時間、上期比較與本期小結會同步使用同一期間。
- 與上期比較整合進本週／本月小結，平均起床時間固定放在小結右側，並顯示相較上週／上月早起或晚起幾小時幾分鐘。
- 週曆／月曆以圓內深淺呈現學習時間、外圍圓環呈現完成率；詳細數字只在指向或點擊日期時顯示。
- 科目分配與學習趨勢各占一半欄位；圓環沿用首頁粗細並將科目字放在環上，點入科目後以同科目深淺色顯示各項目占比、比例與時間，每列固定四項。
